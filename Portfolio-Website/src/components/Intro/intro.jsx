  ...
  return (
    <section id='intro'>
       <div className="introContent">
        ...
        <span className='introText'>I'm <span className='introName'>Khushboo</span><br/></span>
        <span className="introText">Full Stack Web Developer</span>
        <p>Creative thinker to achieve modern business requirements using technical
            solutions. Ability to develop production-ready code using HTML, CSS, JavaScript, Node.js, React,Redux, Tailwind,
            MongoDB,Mongo Atlas,and Express.js,Python, DSA  with expressive user experience. </p>
       ...
       <img src="./image/Profile .png" alt="your photo" className="bg" />
    </section>
  );
}
